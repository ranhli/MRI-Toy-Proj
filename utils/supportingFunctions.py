...
def getData(trnTst='testing',num=163,sigma=.01):
    #num: set this value between 0 to 163. There are total testing 164 slices in testing data
    print('Reading the data. Please wait...')
    filename='/Users/henry/Local/modl-master/dataset.hdf5' #set the correct path here
...
def c2r(inp):
    ...
    """
    if inp.dtype=='complex64' or 'complex128':
        dtype=np.float32
    else:
        dtype=np.float64
